...
const Newsletter = () => {
   return (
        <>
        <div className='px-2 sm:px-4 md:px-6 lg:px-20 pt-20 pb-20 '>
        <div className="w-full bg-slate-900 px-2 text-center text-white py-20 flex flex-col items-center justify-center rounded-xl">
                ...
                <div className="flex items-center justify-center mt-10 border border-slate-600 focus-within:outline focus-within:outline-primary text-sm rounded-full h-14 max-w-md w-full">
                    ...
                    <button className="bg-primary text-white rounded-full h-11 mr-1 px-8 flex items-center justify-center hover:scale-105 duration-300 cursor-pointer">
                        Subscribe now
                    </button>
                </div>
            </div>
