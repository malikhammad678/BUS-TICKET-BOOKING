...
export const AppContextProvider = ({ children }) => {
    ...
    const getTotalNumberBuses = async () => {
        try {
            ...
            if (data.success) setTotalNoBuses(data.totalBuses)
        } catch (error) {
    ...
    const getTotalNumberUsers = async () => {
        try {
            ...
            if (data.success) setTotalNoUsers(data.totalUsers)
        } catch (error) {
            console.log(error.response?.data?.message || 'Error occurred')
        }
    }
    ...
    const getTotalNumberBookings = async () => {
        try {
            ...
            if (data.success) setTotalNoBookings(data.totalBookings)
        } catch (error) {
            console.log(error.response?.data?.message || 'Error occurred')
        }
    }
    ...
    const addNewBus = async (form) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${BACKEND_URL}/bus/add`, formData, {
    ...
    const getAllBuses = async () => {
        try {
            ...
            if (data.success) setWebBuses(data.buses)
        } catch (error) {
    ...
    const getUserBookings = async () => {
        try {
            const { data } = await axios.get(`${BACKEND_URL}/booking/my-bookings`, {
    ...
    const value = {
        loginUser, setLoginUser, navigate, isOwnerLogin, setIsOwnerLogin, AdminLogin, adminToken,
        isAdminLoading, setAdminToken, totalNoBuses, totalNoUsers, totalNoBookings, bookings, buses,
